...
public class My_BFS_Functions
{
	// Constructor for Initialization
	public My_BFS_Functions(int[][] goal_Matrix)
	{
	...
	public My_Puzzle_Node solve_Puzzle_BFS(int[][] start_Mat, int blank_X, int blank_Y)
	{
		Queue<My_Puzzle_Node> node_Queue = new LinkedList<My_Puzzle_Node>();
